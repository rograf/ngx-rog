...
@Component({
  selector: 'app-table-vs-pag',
  templateUrl: './table-vs-pag.component.html',
  styleUrls: ['./table-vs-pag.component.scss']
})
export class TableVsPagComponent implements OnInit {
